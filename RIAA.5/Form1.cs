...
public partial class Form1 : Form
    {
        ...
        public void Clear()
        {
            ...
            TabHG_TextBox_StartPoint_x2.Text = "-1";
            TabHG_TextBox_Optional_eps.Text = "0,00001";
            TabHG_TextBox_1_СoeFunc.Text = "2";
            TabHG_TextBox_2_СoeFunc.Text = "3";
            TabHG_TextBox_3_СoeFunc.Text = "5";
            TabHG_TextBox_5_СoeFunc.Text = "1";
            TabHG_TextBox_6_СoeFunc.Text = "1";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Hook(pogr, x, 0, 0, 0, tb1, tb2);
            text();
            x[0] = double.Parse(TabHG_TextBox_StartPoint_x1.Text);
            x[1] = double.Parse(TabHG_TextBox_StartPoint_x2.Text);
            Hook(pogr, x, 1, 0, 0, tb1, tb2);
            text1();
        ...
        /// Точка
        /// </summary>
        /// <param name="xxx1"></param>
        /// <param name="xxx2"></param>
        /// <param name="key"></param>
        public void Point(double xxx1, double xxx2, int key)
        {
            if (key == 0)
            {
                TabHG_tableLayoutPanel_panel_UP_Graph_1.Invalidate();
        ...
        /// <param name="shtraf"></param>
        /// <param name="mu"></param>
        /// <param name="tb1"></param>
        /// <param name="tb2"></param>
        /// <returns></returns>
        public double[] Hook(double pogr, double[] x, int cps, int shtraf, double mu, double[] tb1, double[] tb2)
        {
            int i;
        ...
        */
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                pogr = double.Parse(TabHG_TextBox_Optional_eps.Text);
                ru = Hook(pogr, re, 2, 1, mu, tb1, tb2);
                re = ru;
